namespace Kazue.Infrastructure.Queries.Status;

public class StatusQuery
{
    public const string STATUS_SP_CREATE = "STATUS_SP_CREATE";

    public const string STATUS_SP_DELETE = "STATUS_SP_DELETE";
